...
/*   Updated: 2022/05/29 14:21:45 by obelkhad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_args(t_data *data, char **argv)
{
	...
	data->t_die = (size_t)ft_atoi(argv[2]);
	...
	if (data->nbr_philo <= 0 || data->nbr_philo > 200 || data->t_die < 0 || \
...
int	initialing(t_data *data)
{
	...
	pthread_mutex_init(&data->is_die, NULL))
		return (1);
